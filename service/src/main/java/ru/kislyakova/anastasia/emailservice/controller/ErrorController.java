...
import ru.kislyakova.anastasia.emailmodel.entity.Error;
import ru.kislyakova.anastasia.emailservice.exception.SchedulerApiException;

import java.util.List;
import java.util.stream.Collectors;

@RestControllerAdvice(basePackages = "ru.kislyakova.anastasia.emailservice.controller")
